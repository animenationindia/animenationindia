    ...
    <main className="min-h-screen bg-[#050716] pt-32 lg:pt-36 pb-20 selection:bg-[#ff4dd2] selection:text-black">
      <div className="container mx-auto px-4 max-w-[1400px]">
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          {page > 1 && (
            <Link href={`/characters?page=${page - 1}`} className="flex items-center gap-1 px-4 py-2 bg-[#121326] hover:bg-[#ff4dd2] text-white hover:text-black rounded-xl font-bold border border-white/10 transition-all cursor-pointer text-sm">
