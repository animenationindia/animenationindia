      ...
      <div className="container mx-auto px-4 max-w-[1400px]">
        <div className="mb-10">
          ...
          <p className="text-gray-400 mt-2 font-medium">
            The most favorited voice actors, directors, and creators.
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          {page > 1 && (
            <Link href={`/staff?page=${page - 1}`} className="flex items-center gap-1 px-4 py-2 bg-[#121214] hover:bg-[#ff6400] text-white hover:text-white rounded-lg font-bold border border-white/5 transition-colors cursor-pointer">
