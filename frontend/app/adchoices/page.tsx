        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#121326]/60 backdrop-blur-xl border border-[#2A2B30]/40 rounded-2xl p-6 md:p-8 hover:border-[#f47521]/50 transition-colors">
            ...
            <ul className="list-disc text-[#8A8A93] pl-[6rem] space-y-2">
              <li>Visit the <a href="https://optout.aboutads.info/" target="_blank" rel="noreferrer" className="text-[#ff4dd2] hover:underline">Digital Advertising Alliance (DAA) WebChoices Tool</a>.</li>
              <li>Visit the <a href="https://optout.networkadvertising.org/" target="_blank" rel="noreferrer" className="text-[#ff4dd2] hover:underline">Network Advertising Initiative (NAI) Opt-Out Page</a>.</li>
          ...
          <div className="bg-[#121326]/60 backdrop-blur-xl border border-[#2A2B30]/40 rounded-2xl p-6 md:p-8 hover:border-green-500/50 transition-colors">
            ...
            <p className="text-[#8A8A93] leading-relaxed text-base pl-[4.5rem]">
              You can further control your ad experience by managing your cookie preferences. Visit our <a href="/cookies" className="text-[#ff4dd2] hover:underline">Cookie Preferences</a> page to toggle tracking for marketing and analytics purposes. You can also clear or block cookies directly from your web browser settings.
            </p>
          </div>
