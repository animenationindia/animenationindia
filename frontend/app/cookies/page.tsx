      ...
      <div className="container mx-auto px-4 max-w-[900px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-6">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-6 flex items-center gap-2 uppercase tracking-wide">
              <ShieldCheck className="text-[#ff4dd2]" /> Your Preferences
            </h2>

            {/* Essential Cookies */}
            <div className="bg-[#12131A]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-6 shadow-lg">
              ...
              <div className="mt-4 pt-4 border-t border-[#2A2B30]/50 text-[10px] text-gray-500 font-black uppercase tracking-wider">
                Always Active
              </div>
            </div>

            {/* Analytics Cookies */}
            <div className={`bg-[#12131A]/80 backdrop-blur-xl border ${analytics ? 'border-[#ff4dd2]/40' : 'border-white/5'} rounded-3xl p-6 shadow-lg transition-colors duration-300`}>
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-white font-bold text-lg mb-1 flex items-center gap-2">
                ...
                <button 
                  ...
                  className={`w-12 h-6 rounded-full flex items-center px-1 shrink-0 mt-1 transition-colors duration-300 cursor-pointer ${analytics ? 'bg-[#ff4dd2]' : 'bg-[#25252D] border border-[#2A2B30]'}`}
                >
                  <motion.div 
                    layout 
            ...
            {/* Marketing Cookies */}
            <div className={`bg-[#12131A]/80 backdrop-blur-xl border ${marketing ? 'border-[#ff4dd2]/40' : 'border-white/5'} rounded-3xl p-6 shadow-lg transition-colors duration-300`}>
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-white font-bold text-lg mb-1 flex items-center gap-2">
                ...
                <button 
                  ...
                  className={`w-12 h-6 rounded-full flex items-center px-1 shrink-0 mt-1 transition-colors duration-300 cursor-pointer ${marketing ? 'bg-[#ff4dd2]' : 'bg-[#25252D] border border-[#2A2B30]'}`}
                >
                  <motion.div 
                    layout 
                    className="w-4 h-4 bg-white rounded-full shadow-md"
            ...
            <div className="pt-4">
              <button 
                onClick={handleSave}
                className="w-full relative overflow-hidden group bg-gradient-to-r from-[#ff4dd2] to-[#f47521] hover:opacity-90 text-white font-extrabold uppercase py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(255,77,210,0.3)] hover:shadow-[0_0_30px_rgba(255,77,210,0.5)] active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer text-sm tracking-widest"
              >
                <Save size={18} />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#121326]/60 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 space-y-6">
              <div>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">How we use them</h3>
                <p className="text-[#8A8A93] text-sm leading-relaxed">
