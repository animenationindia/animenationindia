// frontend/lib/titleCleaner.ts
// Universal English Title Normalizer for Anime & Manga (TypeScript)
...
function cleanJapaneseSuffixes(str: string): string {
  if (!str) return '';
  return str
...
export function toEnglishTitle(raw: any, fallback = 'Anime'): string {
...
export function normalizeTitleObject(rawTitle: any): { english: string; romaji: string; native?: string } {
